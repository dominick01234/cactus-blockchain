...
from cactus.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot
...
from cactus.util.streamable import dataclass_from_dict, recurse_jsonify

log = logging.getLogger(__name__)


def _create_shutdown_file() -> IO:
    return tempfile.NamedTemporaryFile(prefix="cactus_full_node_weight_proof_handler_executor_shutdown_trigger")
