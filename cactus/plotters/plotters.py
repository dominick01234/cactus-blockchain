...
from cactus.plotters.bladebit import get_bladebit_install_info, plot_bladebit
from cactus.plotters.cactuspos import get_cactuspos_install_info, plot_cactus
from cactus.plotters.madmax import get_madmax_install_info, plot_madmax
from cactus.plotters.install_plotter import install_plotter
...
def build_parser(subparsers, root_path, option_list, name, plotter_desc):
    ...
    for option in option_list:
        ...
        u_default = 0 if name == "cactuspos" else 256
...
def call_plotters(root_path: Path, args):
    ...
    build_parser(subparsers, root_path, cactus_plotter, "cactuspos", "Cactuspos Plotter")
...
def get_available_plotters(root_path) -> Dict[str, Any]:
    ...
    cactuspos: Optional[Dict[str, Any]] = get_cactuspos_install_info()
    ...
    if cactuspos is not None:
        plotters["cactuspos"] = cactuspos
