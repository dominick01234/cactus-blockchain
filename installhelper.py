...
# Gets the version from the result of "cactus version"
...
def update_version(package_json_path: str):
    ...
    data["version"] = get_cactus_version()
...
if __name__ == "__main__":
    update_version(f"{os.path.dirname(__file__)}/cactus-blockchain-gui/package.json")
    update_version(f"{os.path.dirname(__file__)}/cactus-blockchain-gui/packages/gui/package.json")
