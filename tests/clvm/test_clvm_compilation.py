...
wallet_program_files = set(
    [
        "cactus/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "cactus/wallet/puzzles/cat_v2.clvm",
        "cactus/wallet/puzzles/cactuslisp_deserialisation.clvm",
        "cactus/wallet/puzzles/rom_bootstrap_generator.clvm",
        "cactus/wallet/puzzles/generator_for_single_coin.clvm",
        "cactus/wallet/puzzles/lock.inner.puzzle.clvm",
        "cactus/wallet/puzzles/p2_conditions.clvm",
        "cactus/wallet/puzzles/p2_delegated_conditions.clvm",
        "cactus/wallet/puzzles/p2_delegated_puzzle.clvm",
        "cactus/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "cactus/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "cactus/wallet/puzzles/p2_puzzle_hash.clvm",
        "cactus/wallet/puzzles/rl_aggregation.clvm",
        "cactus/wallet/puzzles/rl.clvm",
        "cactus/wallet/puzzles/sha256tree_module.clvm",
        "cactus/wallet/puzzles/singleton_top_layer.clvm",
        "cactus/wallet/puzzles/did_innerpuz.clvm",
        "cactus/wallet/puzzles/decompress_puzzle.clvm",
        "cactus/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "cactus/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "cactus/wallet/puzzles/block_program_zero.clvm",
        "cactus/wallet/puzzles/test_generator_deserialize.clvm",
        "cactus/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "cactus/wallet/puzzles/p2_singleton.clvm",
        "cactus/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "cactus/wallet/puzzles/pool_member_innerpuz.clvm",
        "cactus/wallet/puzzles/singleton_launcher.clvm",
        "cactus/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
        "cactus/wallet/puzzles/genesis_by_puzzle_hash.clvm",
        "cactus/wallet/puzzles/everything_with_signature.clvm",
        "cactus/wallet/puzzles/delegated_tail.clvm",
        "cactus/wallet/puzzles/settlement_payments.clvm",
        "cactus/wallet/puzzles/genesis_by_coin_id.clvm",
        "cactus/wallet/puzzles/singleton_top_layer_v1_1.clvm",
        "cactus/wallet/puzzles/nft_metadata_updater_default.clvm",
        "cactus/wallet/puzzles/nft_metadata_updater_updateable.clvm",
        "cactus/wallet/puzzles/nft_state_layer.clvm",
        "cactus/wallet/puzzles/nft_ownership_layer.clvm",
        "cactus/wallet/puzzles/nft_ownership_transfer_program_one_way_claim_with_royalties.clvm",
        "cactus/wallet/puzzles/decompress_block_spends.clvm",
    ]
)

clvm_include_files = set(
    ["cactus/wallet/puzzles/create-lock-puzzlehash.clvm", "cactus/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "cactus/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to cactus/wallet/puzzles, but not added to `wallet_program_files`
        """
