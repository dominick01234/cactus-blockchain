...
from cactus.protocols.wallet_protocol import RespondRemovals
from cactus.simulator.block_tools import BlockTools
from cactus.types.blockchain_format.coin import Coin
from cactus.types.blockchain_format.program import Program
from cactus.types.blockchain_format.sized_bytes import bytes4, bytes32
...
from cactus.util.streamable import (
    DefinitionError,
    Streamable,
    is_type_List,
